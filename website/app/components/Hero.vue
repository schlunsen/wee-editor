  ...
  <section class="hero">
    ...
    <div class="container">
      <div class="hero-content">
        ...
        <div class="hero-icon">
          <img :src="`${$config.app.baseURL}images/logo-hacker-cat.png`" alt="Wee - Hacker Cat" class="hero-logo" />
        </div>

        <p class="hero-eyebrow">The cockpit for engineers who run AI at scale</p>

        <h1 class="hero-title">
          <span class="title-gradient">Wee</span>
        </h1>
        ...
        <p class="hero-tagline">
          Sandboxed sessions. Full terminal access. Real-time analytics. Multi-provider.
        </p>

        <div class="hero-badges">
          <a href="https://github.com/schlunsen/wee/stargazers" target="_blank">
            <img src="https://img.shields.io/github/stars/schlunsen/wee?style=flat&logo=github&color=yellow" alt="GitHub Stars">
          </a>
          <img src="https://img.shields.io/badge/Go-1.23%2B-00ADD8?style=flat&logo=go" alt="Go Version">
          <img src="https://img.shields.io/badge/License-MIT-yellow.svg" alt="License">
          <img src="https://img.shields.io/github/v/release/schlunsen/wee" alt="Release">
        </div>

        <div class="hero-cta">
          <a href="#installation" class="btn btn-primary">Get Started</a>
          <a href="https://github.com/schlunsen/wee" class="btn btn-secondary" target="_blank">
...
.title-gradient {
  background: linear-gradient(135deg, #67e8f9 0%, #a78bfa 50%, #4ade80 100%);
