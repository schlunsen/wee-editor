  ...
  <aside class="sessions-sidebar">
    <div class="sidebar-header">
      <div class="header-top">
        <h3>Sessions</h3>
        <details class="session-actions"><summary aria-label="Session actions" title="Session actions">⋯</summary>
...
.sessions-sidebar { font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; }
.header-top { display: flex; justify-content: space-between; align-items: center; }
.session-actions { position: relative; }
.session-actions summary { cursor: pointer; list-style: none; padding: 0 8px; color: var(--text-secondary); font-size: 1.25rem; }
.session-actions summary::-webkit-details-marker { display: none; }
.session-actions .btn-delete-all { position: absolute; right: 0; top: 100%; z-index: 10; width: 190px; background: var(--bg-secondary); border: 1px solid var(--border-color); box-shadow: 0 4px 12px var(--shadow-color); }
</style>
